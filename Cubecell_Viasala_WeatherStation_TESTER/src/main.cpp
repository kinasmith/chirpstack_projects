...
/**
 * AB02:
 * devEUI, MSB:  0d14ea46862052c1
 * App Key, MSB: E0226ED8945E47B7369B1498D7955B61
*/
// uint8_t devEui[] = { 0x0d, 0x14, 0xea, 0x46, 0x86, 0x20, 0x52, 0xc1 };
// uint8_t appEui[] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
// uint8_t appKey[] = { 0xE0, 0x22, 0x6E, 0xD8, 0x94, 0x5E, 0x47, 0xB7, 0x36, 0x9B, 0x14, 0x98, 0xD7, 0x95, 0x5B, 0x61 };
/**
 * AB01:
 * devEUI, MSB:  0d14ea46862052c2
 * App Key, MSB: FD8B309DC73927623A06AB0ABDA2A2F7
 */
...
// 0R0,Dm=312D,Sm=0.4M,Ta=9.0C,Ua=88.6P,Pa=1006.9H,Rc=0.00M,Rd=0s,Ri=0.0M,Vs=12.1V
  ...
  //  if(Serial1.available()) {
    ...
    for(int i = 0; i < MEAS_ARRAY_SIZE-2; i++) { 
      // measFLOAT[i] = meas[i+1].toFloat(); //removes first value of array ("0R0")
      measFLOAT[i] = random(1000)/100.; //removes first value of array ("0R0")
    }
    //scale temperatures to avoid negative values
